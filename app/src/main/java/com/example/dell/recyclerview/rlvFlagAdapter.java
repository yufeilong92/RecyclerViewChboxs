...
public class rlvFlagAdapter extends RecyclerView.Adapter<rlvFlagAdapter.ViewHolder> {
    ...
    public rlvFlagAdapter(ArrayList mData, Context mContext) {
        this.mData = mData;
        this.mContext = mContext;
        inflater = LayoutInflater.from(mContext);
        mList = new ArrayList<>();
        stringList = new ArrayList<>();
        flags = new boolean[mData.size()];
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.mchb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            holder.mchb.setChecked(flags[position]);
